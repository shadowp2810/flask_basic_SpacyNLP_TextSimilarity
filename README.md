# flask_basic_SpacyNLP_TextSimilarity
A basic flask web api with a token limit to check similarity between two texts by spaCy's NLP as one service and MongoDB db store as another service, with both services managed by docker.
<br><br>
![flask_basic_spaCy_NLP_TextSimilarity](demo/demo.gif)
<br><br>
...
Each user gets 10 tokens <br>
Store a sentence our database for 1 token <br>
Retrieve his stored sentence on our database for 1 token <br>
...
CMD ["python3", "textSimApi.py"] <br>
' <br>

##### Other avalilable spaCy NLP model packages at https://spacy.io/usage/models
